<div class="actions columns large-2 medium-3">
    <h3><?= __('Actions') ?></h3>
    <ul class="side-nav">
        <li><?= $this->Html->link(__('Edit Opestado'), ['action' => 'edit', $opestado->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Opestado'), ['action' => 'delete', $opestado->id], ['confirm' => __('Are you sure you want to delete # {0}?', $opestado->id)]) ?> </li>
...
<div class="opestado view col-md-10">
    <h2><?= h($opestado->id) ?></h2>
    <div class="row">
        <div class="large-5 columns strings">
            <h6 class="subheader"><?= __('Opestado') ?></h6>
            <p><?= h($opestado->opestado) ?></p>
        </div>
        <div class="large-2 columns numbers end">
            <h6 class="subheader"><?= __('Id') ?></h6>
            <p><?= $this->Number->format($opestado->id) ?></p>
            <h6 class="subheader"><?= __('Order') ?></h6>
            <p><?= $this->Number->format($opestado->order) ?></p>
        </div>
    </div>
</div>
<div class="related row">
    ...
    <?php if (!empty($opestado->oportunidades)): ?>
    <table cellpadding="0" cellspacing="0">
        <tr>
            ...
            <th><?= __('Valor') ?></th>
            <th><?= __('Users Id') ?></th>
            <th><?= __('Opestado Id') ?></th>
            <th class="actions"><?= __('Actions') ?></th>
        </tr>
        <?php foreach ($opestado->oportunidades as $oportunidades): ?>
        <tr>
            ...
            <td><?= h($oportunidades->opestado_id) ?></td>
